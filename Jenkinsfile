   ...
   stage('test site'){
    ...
    //   }
        ...
        stage('deploy web-app with ansible'){
             //    container('ansible'){
                 ansiblePlaybook credentialsId: inventory: 'inventory.yml', playbook: 'my_playbook.yml'
